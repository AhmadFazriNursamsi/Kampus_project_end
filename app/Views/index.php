  ...
  <body>
	...
	<div class="section">
		<div class="container">
				...
				<div class="col-12 text-center align-self-center py-5">
					<div class="section pb-5 pt-5 pt-sm-2 text-center">
						...
						<div class="card-3d-wrap mx-auto">
							<div class="card-3d-wrapper" style="height: 500px;">
            ...
            <form id="form_regis" method="post">
              <div class="form-group ">
                <input type="text" name="nim" class="form-style" placeholder="Your NIM" id="nim" autocomplete="off">
                <i class="input-icon uil uil-at"></i>
              </div>	
              <div class="form-group mt-2">
            ...
            <div class="form-group mt-2">
              <input type="text" name="phone_number" class="form-style" placeholder="Your Phone Number" id="phone_number" autocomplete="off">
              <i class="input-icon uil uil-at"></i>
            </div>	
